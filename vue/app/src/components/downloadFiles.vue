                    ...
                    .then (res=>{
                      if (res.data.code == 1){
                          //download default video
                            document.getElementById('files-progress').innerHTML += 
                          `<br><h2 style="margin-top:10px; color: white; font-size: 1.5vw; letter-spacing: 10px; margin-button:10px;">Descargando video por defecto</h2><hr><h1 id='item-default' style=' color: white; font-size: 1.5vw;margin-top: 2%;margin-bottom: 5px;' class="">Descargando ${nameDefault}</h1>
